...
export default function AdminCmsPage() {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<CmsForm>({
  ...
  return (
    <div className="p-6 lg:p-8 space-y-8">
      ...
      {showAddForm && (
        ...
        >
          <h3 className="font-bold text-base border-b border-border pb-2">New Content Block Configuration</h3>
